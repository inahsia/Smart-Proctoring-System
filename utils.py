...
f_name_directory = r'C:\Users\singh\OneDrive\Desktop\anti cheating proctoring system\static\OutputAudios'
# Capture
cap = None
...
def reduceBitRate (input_file,output_file):
   ...
   ffmpeg_path = r"C:\Users\singh\OneDrive\Desktop\anti cheating proctoring system\ffmpeg-7.1.1-essentials_build\bin\ffmpeg.exe"  # Replace with the actual path to ffmpeg.exe on your system
...
def deleteTrashVideos():
    global video
    video_folder = r'C:\Users\singh\OneDrive\Desktop\anti cheating proctoring system'
